...
{
    public class AboutRightValidation : AbstractValidator<AboutRightContent>
    {
        public AboutRightValidation()
        {
           ...
           .WithMessage(DefaultConstantValue.GetRequiredMessage("Şəkil"));
            ...
            .NotEmpty()
            .WithMessage(DefaultConstantValue.GetRequiredMessage("Progress"));
        }
    }
}
